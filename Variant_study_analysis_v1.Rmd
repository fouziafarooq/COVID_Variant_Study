...
japan_shoji_AGG_df <- read_excel('/Users/fouziafarooq/Library/CloudStorage/Box-Box/Perinatal COVID-19 PMA/Data for Analysis/Round 2 Analysis - January 2021/72. Japan (Shoji)/Variant_Study - Shell Table_Aggregate Data Request_Japan.xlsx', sheet = "Japan") # SITE 72
...
AGGREGATE DATA FROM SWITZERLAND AND FRANCE (GUILLAUME)
```{r}
