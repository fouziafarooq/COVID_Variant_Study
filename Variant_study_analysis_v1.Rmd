...
Metagen package:
# ```{r}
#   X <-metagen(logOR, logSE,
#               studlab=paste(ID), data=df14,
#               fixed= FALSE, random=TRUE,
#               subset=NULL, sm="OR",
#               method.tau="REML",
#               subgroup =df14$site_name,
#               title="Variant")
# summary(X)
# ```
...
meta_fun <- function(outcome.var, strain.var, ref.strain) {
  ...
  write.csv(x=dat, file=paste0('data_out/VariantStudy_MetaForestPlot.', ref.strain, "_", strain.var, '.', outcome.var, '.csv'))
...
meta.fun.call <- meta_fun(outcome.var = "preterm_labor", ref.strain = "Omicron", strain.var = "Delta")
```
