...
compiled_ipd_20221109 <- read_dta('data/Compiled_IPD_Data_221109.dta') #MOST UPDATED FILE.  REOMOVE _old and _new.  This has comprehensive data now. 
...
```{r}
table(compiled_ipd_20221109$site_id)
```
...
```{r, include=FALSE}
site_id_new <- compiled_ipd_20221109$site_id
...
compiled_ipd_data <- compiled_ipd_20221109
...
est_table_df2 <- est_table_df %>%
  ...
  mutate(Outcome = factor(Outcome, 
           ...
           labels = c("Hospitalization", "ICU admission", "Critical care", "Ventilation", "Pneumonia",  "Maternal death",
                ...
                # fetal outcomes:
                "Stillbirth site", "Stillbrith", "SAB site", "Tab site",
                "Neonatal death", "Early neonatal death", "Perinatal death", "Perinatal death site",
                "NICU admission", "LBW", "vLBW", "vPTB", "vPTB2", "PTB", "PTB2", "SGA", "eSGA", "Fetal composite outcome"))) %>%
...
outcome_vec <- c("matdeath","covid_hosp", "ICUadmit", "critcare", "ventilation", "pneumonia",
                "prdeath", "place_abrupt", "preterm", "preterm_labor", "haemorrhage", "embolicdz",
                "preeclampsia", "eclampsia", "pre_or_eclampsia", "hpd_any", "hpd_postcovid", "c_section",
                "c_intrap","mat_composite_outcome",
                # fetal outcomes: 
                "stillbirth_site", "stillbirth_28", "sab_site", "tab_site", "neonatal_death", "earlyneo_death", 
  ...
  mutate(Strain = factor(Strain, 
    ...
    mutate(Outcome = factor(Outcome,
           levels = c("covid_hosp", "ICUadmit", "critcare", "ventilation", "pneumonia","matdeath",
                ...
                "stillbirth_site", "stillbirth_28", "sab_site", "tab_site", "neonatal_death", "earlyneo_death", 
                "perinatal_death28", "perinatal_deathsite", "nicu","lowbirthweight", "verylowbirthweight",
                 "verypreterm",  "preterm", "sga", "extremesga", "fetal_composite_outcome"),
           ...
           labels = c("Hospitalization", "ICU admission", "Critical care", "Ventilation", "Pneumonia",  "Maternal death",
                ...
                "Stillbirth site", "Stillbrith", "SAB site", "Tab site",
                "Neonatal death", "Early neonatal death", "Perinatal death", "Perinatal death site",
                "NICU admission", "LBW", "vLBW", "vPTB", "PTB", "SGA", "eSGA", "Fetal composite outcome")))
