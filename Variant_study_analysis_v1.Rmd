...
<!-- ```{r} -->
<!-- # HARDCODED HERE -->
<!-- # outcomes: haemorrhage, diab_prepreg, preterm_labor, pre_or_eclampsia, eclampsia, covid_icu -->
<!-- # Reshaping data -->
...
<!--   dplyr::filter(outcome=="pre_or_eclampsia") %>%  -->
...
<!-- dat <- escalc(measure="RR", ai=pos_Alpha, bi=neg_Alpha, ci=pos_Pre_alpha, di=neg_Pre_alpha, data=df14.alpha, -->
...
<!--        ilab=cbind(pos_Alpha, neg_Alpha, pos_Pre_alpha, neg_Pre_alpha), ilab.xpos=c(-9.5,-8,-6,-4.5),  -->
<!--                      cex=.75, header="Site name", mlab="") -->
<!-- op <- par(cex=.75, font=2) -->
<!-- text(c(-9.5,-8,-6,-4.5), 15, c("Alpha+", "Alpha-", "Prealpha+", "Prealpha-")) -->
<!-- text(c(-8.75,-5.25),     16, c("Dominant_strain", "Reference_strain")) -->
<!-- par(op) -->
...
# Reshaping data
meta_fun <- function(outcome.var, strain.var) {
...
meta.fun.call <- meta_fun(outcome.var = "hyperten_prepreg", strain.var = "Alpha")
```
...
***RANDOM REGRESSIONS WITH IPD DATA***
