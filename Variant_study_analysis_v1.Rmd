...
# compiled_ipd_20221109 <- read_dta('Compiled_IPD_Data_221109.dta') #MOST UPDATED FILE.  REOMOVE _old and _new.  This has comprehensive data now. 
...
# http://127.0.0.1:57661/help/library/meta/help/meta-object
  ...
  pdf(file=paste0("plots/20221109_domvar_mixed_50/VariantStudy_MetaForestPlot_teststr_", teststr, "_refstr_", refstr, ".pdf"), width=10, height=65) # pdf saving has to go before making the plot and at the end have to say dev.off()
...
est_table_df <- heatmap_data_df %>%
 ...
 arrange(Outcome)
write.csv(est_table_df, 'data_out/variant_study_pooled_table.csv', row.names = FALSE)
```
...
outcome_vec <- c("matdeath","covid_hosp", "ICUadmit", "covid_icu", "critcare", "ventilation", "pneumonia",
                "rdeath", "place_abrupt", "preterm", "preterm_labor", "haemorrhage", "embolicdz",
                ...
                "perinatal_death28", "perinatal_deathsite", "nicu","lowbirthweight", "verylowbirthweight",
                 "verypreterm",   "sga", "extremesga", "fetal_composite_outcome")
...
heatmap_data$Outcome <- factor(heatmap_data$Outcome, 
 ...
 ggsave(paste0('plots/heatmap/20221113/dom_strain_50/variant_study_heatmap_',
               format(Sys.time(), "%Y-%m-%d_%H-%M"),
               "_refstrain", 
               rs,
               "_n_study>1.pdf"),
