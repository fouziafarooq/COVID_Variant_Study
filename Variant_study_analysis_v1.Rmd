...
check.df <- df8 %>% dplyr::select(country) 
colnames(df8)
ggplot() +
...
ggsave(filename = 'data_out/covid_variant_country_20220717.pdf', width = 6, height = 30, units = "in") # DON'T NEED TO WRITE THIS OUT EVERYTIME.
