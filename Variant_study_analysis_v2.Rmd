...
df14.alpha <- df14.alpha %>%
  mutate(logRR = log(rr_ff(pos_Pre_alpha, pos_treatment_strain, neg_Pre_alpha, neg_treatment_strain)),
         logSE = se_logrr_ff(pos_Pre_alpha, pos_treatment_strain, neg_Pre_alpha, neg_treatment_strain))
...
#generate forest plot:HERE
  pdf(file='plots/VariantStudy_MetaForestPlot_alpha-prealpha.pdf', width=8.5, height=22) # pdf saving has to go before making the plot and at the end have to say dev.off()
